...
function submitAnalysis() {
    ...
    if (evalNum == '1') {
        if (document.getElementById('analysisDD1_1').value == 'the reactants are' && document.getElementById('analysisDD2_1').value == 'chemical energy') {
			...
			wrongSound.play();
            document.getElementById('alertBoxAnalysisFeedbackMainText').innerHTML = "<img src='mod_incorrect.png'><b><font color='red'>Incorrect</font> Analysis</font></b><br><br><span id='aBAFMT_Intro'> Nice try, but your analysis is <font color='red'>incorrect</font>. <br><br><img src='edit.png'><b>Use <font color='green'>evidence</font> from your <font color='blue'>data table</font> and revise <font color='red'>both answers</font>.</b><br><br>You lost <font color='cyan'>one chance</font>.<br><b>-</b><img src='heartUsed.png' style='width: 20px; margin-top: 10px; display: inline-block;'/>";//:</span> </br></br> During photosynthesis, if the reactants are present, <font color='red' id='aBAFMT_1'>light energy</font><img width='20' height='20'id='aFT_1' src='redX.png'> is transformed into <font color='red' id='aBAFMT_2'>chemical energy</font><img width='20' height='20' id='aFT_2' src='redX.png'>.";
            ...
            if (document.getElementById('analysisDD1_1').value == 'the reactants are') {	
                ...
                document.getElementById('aBAFMT_Intro').innerHTML = "<img src='goodprogress.png'>You are making a good progress, but your <font color='red'><u>second</u></font> response is <font color='red'>incorrect</font>. <p style='background-color: #99ff99;'><b>What happens to <font color='orange'>light energy</font> when <font color='blue'>carbon dioxide and water</font> are present during photosynthesis?</b></p>You lost <font color='cyan'>one chance</font>.<br><b>-</b><img src='heartUsed.png' style='width: 20px; margin-top: 10px; display: inline-block;'/>";
                ...
                document.getElementById('aBAFMT_Intro').innerHTML = "<img src='goodprogress.png'> You are making a good progress, but your <font color='red'><b>first</b></font> response is <font color='red'>incorrect</font>.<p style='background-color:#ffffe6;'><font color='green'><b>When can photosynthesis happen?</b></font></p>Use <font color='green'>evidence</font> from your <font color='blue'>data table</font> and revise your <font color='red'><b>first</b></font> response.<br><br>You lost <font color='blue'>one chance</font>.<br><b>-</b><img src='heartUsed.png' style='width: 20px; margin-top: 10px; display: inline-block;'/";
